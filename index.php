<?php
    ...
    $conn = new mysqli('serwer1911877.home.pl', '31775790_etl', 'fOXMs2si', '31775790_etl');
    ...
    if(isset($_GET['ajax']))
    {
        ...
        echo shell_exec('python '.__DIR__.'/webscraper.py '.$process.' '.$postcode);
    }
?>
        ...
        <div class="row">
            <div class="row">
                <form class="mr-1" method="post" action="">
                    <input type="hidden" name="process" value="processExtract" class="mt-1 mb-3">
                    Postcode: <input type="text" name="postcode" value="" class="mt-1 mb-3">
                    <input type="button" value="Extract" id="processExtract" class="ETLButton mt-1 mb-3">
                </form>
                <form class="mr-1" method="post" action="">
                    <input type="hidden" name="process" value="processTransform" class="mt-1 mb-3">
                    <input type="button" value="Transform" id="processTransform" class="ETLButton d-none mt-1 mb-3">
                </form>
                <form class="mr-1" method="post" action="">
                    <input type="hidden" name="process" value="processLoad" class="mt-1 mb-3">
                    <input type="submit" value="Load" id="processLoad" class="ETLButton d-none mt-1 mb-3">
                </form>
